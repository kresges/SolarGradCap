//hi twi master functions header file: twi_master.h 
...
#include <avr/io.h>
//#define TWI_TWBR 3 //400khz TWI clock
...
#define TWCR_RACK   0x18   //receive byte and return ack to slave  
#define TWCR_RNACK  0x20   //receive byte and return nack to slave
#define TWCR_SEND   0x84   //pokes the TWINT flag in TWCR and TWEN

#else
#define TWCR_START  0x10 //send START 
#define TWCR_SEND   0x08 //poke TWINT flag to send another byte 
